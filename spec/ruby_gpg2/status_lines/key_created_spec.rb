...
describe RubyGPG2::StatusLines::KeyCreated do
    ...
    context 'key_types' do
      {
        ...
        it "parses key type #{key_type_string}" do
          ...
          status_line = RubyGPG2::StatusLines::KeyCreated.parse(raw_status_line)
  ...
  context 'properties' do
    it 'uses the raw record from the provided options' do
      status_line = RubyGPG2::StatusLines::KeyCreated.new(
          raw: "[GNUPG:] " +
